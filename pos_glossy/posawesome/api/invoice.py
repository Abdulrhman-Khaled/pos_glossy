...
from pos_glossy.posawesome.doctype.pos_coupon.pos_coupon import update_coupon_code_count
from pos_glossy.posawesome.api.posapp import get_company_domain
