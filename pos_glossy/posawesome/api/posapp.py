...
from pos_glossy.posawesome.doctype.pos_coupon.pos_coupon import check_coupon_code
from pos_glossy.posawesome.doctype.delivery_charges.delivery_charges import (
...
def update_delivery_charge_default_rate(name, default_rate):
    ...
    doc.default_rate = float(default_rate) if default_rate else 0.0
    doc.save()
    frappe.db.commit() 
...
def create_customer(
    ...
    if method == "create":
        ...
        customer_doc.primary_address = primary_address
...
def get_customer_info(customer):
    ...
    res["primary_address"] = customer.primary_address
