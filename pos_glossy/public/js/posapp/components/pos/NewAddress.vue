        ...
        <v-card-text class="pa-0">
          <v-container>
            <v-row>
              ...
              <v-col cols="12">
                <v-text-field dense color="primary" :label="frappe._('Address Line 2')" background-color="white"
                  hide-details v-model="address.address_line2"></v-text-field>
              </v-col>
              <v-col cols="6">
                <v-text-field label="City" dense color="primary" background-color="white" hide-details
                  v-model="address.city"></v-text-field>
              </v-col>
              <v-col cols="6">
                <v-text-field label="State" dense background-color="white" hide-details
