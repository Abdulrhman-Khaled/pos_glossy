    ...
    <v-dialog v-model="isOpen" persistent max-width="600px">
      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="success" :disabled="is_loading" dark @click="submit_dialog">Submit</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-row>
...
export default {
  ...
  methods: {
    ...
    get_opening_dialog_data() {
      const vm = this;
      frappe.call({
        method: 'pos_glossy.pos_glossy.api.posapp.get_opening_dialog_data',
        args: {},
        callback: function (r) {
          if (r.message) {
    ...
    submit_dialog() {
      ...
      const vm = this;
      return frappe
        .call('pos_glossy.pos_glossy.api.posapp.create_opening_voucher', {
