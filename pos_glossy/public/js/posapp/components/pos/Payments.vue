  ...
  <div>
    <v-card class="selection mx-auto grey lighten-5 pa-1" style="max-height: 76vh; height: 76vh">
      ...
      <div class="overflow-y-auto px-2 pt-2" style="max-height: 75vh">
        ...
        <v-divider></v-divider>
        <v-text-field outlined color="primary" :label="frappe._('Reference Number')" background-color="white"
          placeholder="XXXXXXXX" hide-details v-model="invoice_doc.custom_reference_number"
          :value="invoice_doc.custom_reference_number"></v-text-field>
        <v-divider></v-divider>
        <v-row class="px-1 py-0" align="start" no-gutters>
          ...
          <v-col cols="6" v-if="pos_profile.posa_allow_credit_sale && !invoice_doc.is_return">
            <template>
              <v-switch v-model="is_credit_sale" inset class="my-0 py-0">
