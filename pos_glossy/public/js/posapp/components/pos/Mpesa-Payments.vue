  ...
  <v-row justify="center">
    <v-dialog v-model="dialog" max-width="800px" min-width="800px">
      <v-card>
        ...
        <v-container>
          <v-row class="mb-4">
            <v-text-field color="primary" :label="frappe._('Full Name')" background-color="white" hide-details
              v-model="full_name" dense clearable class="mx-4"></v-text-field>
            <v-text-field color="primary" :label="frappe._('Mobile No')" background-color="white" hide-details
              v-model="mobile_no" dense clearable class="mx-4"></v-text-field>
        ...
        <v-card-actions class="mt-4">
          ...
          <v-btn v-if="selected.length" color="success" dark @click="submit_dialog">{{ __('Submit') }}</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-row>
