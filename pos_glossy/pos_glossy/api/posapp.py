...
from pos_glossy.pos_glossy.doctype.pos_coupon.pos_coupon import check_coupon_code
from pos_glossy.pos_glossy.doctype.delivery_charges.delivery_charges import (
